      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
            <img src="public/source/images/hero_bg_2.jpg" alt="Image" class="img-fluid rounded">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="public/source/images/person_1.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="public/source/images/person_2.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="public/source/images/person_4.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
